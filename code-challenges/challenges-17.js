...
// try decreasing it until you hit the base -4 and then reverse the array's comps [16, 11, 6, 1, -4,the reversed numbers 1,6,11,16]
const recursionPattern = (int1, int2) => {
let test = [];
if(int1 > int2){
    let recursion = recursionPattern(int1 - int2,int2);
    let result = recursion.flat(Infinity)
    result.push(int1);
    result.unshift(int1)
    return result;
...
const isPalindrome = (str) => {
    ...
    let string = str.replace(regexexp,"").toLowerCase();
